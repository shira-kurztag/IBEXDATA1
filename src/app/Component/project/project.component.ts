...
onBuildSelect(event: Event) {
  ...
  let id= this.BuildingActive.find(b=>b.buildingNumber==selectedBuildNumber )?.buildingId
  this.getBuild(id);
}

getBuild(buildingId: any) {
  // this.buildingNumber = buildingNumber;
  this.flagBuild = false;
  this.router.navigate(['/buildings', this.project.projectId, buildingId, String(this.flagBuild)]);
}
