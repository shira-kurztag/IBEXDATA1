...
async update1() {
  ...
  addBuilding(){
      this.flagBuild = true;
      this.router.navigate(['/buildings', this.project.projectId,this.buildingNumber,String(this.flagBuild)]);
      console.log("hhgghdfdgffffffffffffffffffffffffffffffffffffffffffffffff");
